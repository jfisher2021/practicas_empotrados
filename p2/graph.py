...
if filename == 'NRTB':
    ...
    data['LATENCIA'] = data['LATENCIA'] / 1000000
    data['LATENCIA'].hist(bins=100, ax=ax, range=[0.00, 5.0], color='green',
                          alpha=0.5, edgecolor='black', label="Non Real Time - idle")
    plt.title('cyclictestURJC RaspberryPi - Kernel No RT', fontsize=40)

elif filename == 'RTB':
    data['LATENCIA'] = data['LATENCIA'] / 100000
    data['LATENCIA'].hist(bins=100, ax=ax, range=[0.00, 5.0], color='blue',
    ...
    data['LATENCIA'] = data['LATENCIA'] / 1000000
    data['LATENCIA'].hist(bins=100, ax=ax, range=[0.00, 50.0], color='green',
